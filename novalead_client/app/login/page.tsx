  ...
  return (
    <div className="grid min-h-screen bg-[#f8fafc] md:grid-cols-2">
      <div className="hidden md:flex flex-col justify-between border-r border-slate-200 bg-white p-10">
        ...
        <div>
          <h1 className="text-4xl font-bold">Find your next best customer with AI.</h1>
          <p className="mt-4 text-slate-600">Turn plain-English prompts into verified B2B decision-makers.</p>
        </div>
      </div>
